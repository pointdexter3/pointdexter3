...
- V3 Quality of life release ❤️‍🔥. Smoother workflow: now you download files from FI overwriting your empty template OFX files (consitent naming), run the script, and upload the files to Simplifi. Improvements include  archiving of your previous conversions (original OFX files and converted CSV), cleaning up overlapping transactions from ealier conversions, and resetting the files between conversions.
